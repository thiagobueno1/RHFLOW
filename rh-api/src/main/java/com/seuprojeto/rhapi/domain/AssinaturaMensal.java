...
public class AssinaturaMensal extends AuditableBase {
    ...
    /** Colaborador responsável pela assinatura */
    ...
    /** Status da assinatura (PENDENTE, ASSINADO, RECUSADO) */
    @Enumerated(EnumType.STRING)
    @Column(nullable = false, length = 20)
    private AssinaturaMensalStatus status = AssinaturaMensalStatus.PENDENTE;

    /** Momento em que o e-mail foi enviado ao colaborador */
    @Column(name = "email_sent_at")
    private LocalDateTime emailSentAt;

    /** Momento em que o colaborador decidiu (aceitou/recusou) */
    ...
    public AssinaturaMensalStatus getStatus() {
        return status;
    }

    public void setStatus(AssinaturaMensalStatus status) {
        this.status = status;
    }
    ...
    public String getDecididoIp() {
        return decididoIp;
    }

    public void setDecididoIp(String decididoIp) {
        this.decididoIp = decididoIp;
    }

    public String getDecididoUa() {
        return decididoUa;
    }

    public void setDecididoUa(String decididoUa) {
        this.decididoUa = decididoUa;
    }
}
